...
$(document).ready(function() {
    ...
    for (let j = 0; j < vyshi.length; j++) {
        ...
        top[j][1]=k;
        top[j][2]=za;
        top[j][3]=Math.round((za/k)*10000)/100 + '%';
        top[j][4]=a;
        top[j][5]=Math.round((a/k)*10000)/100 + '%';
        top[j][6]=ya;
        top[j][7]=Math.round((ya/k)*10000)/100 + '%';
        top[j][8]=v;
        top[j][9]=Math.round((v/k)*10000)/100 + '%';
        top[j][10]=Ga;
        top[j][11]=Math.round((Ga/k)*10000)/100 + '%';
        top[j][12]=Ba;
        top[j][13]=Math.round((Ba/k)*10000)/100 + '%';
        top[j][14]=Math.round(((a+za*5+ya*(-3)+v*(-10))/k)*100)/100;
    }
